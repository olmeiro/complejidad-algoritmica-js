...
class MySinglyLinkedList {
  ...
  palindrome(){
    ...
    let endFirstMiddle = this.findMiddle(this.head) 
    const startSecondMiddle = this.invertirLinkedList(endFirstMiddle.next);
    
    let esPalindrome = true
    let p1 = this.head
    let p2 = startSecondMiddle

    while(esPalindrome === true && p2 !== null){
    ...
    endFirstMiddle.next = this.invertirLinkedList(startSecondMiddle.next)
...
console.log(myLinkedList.palindrome())
